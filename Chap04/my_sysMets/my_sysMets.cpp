...
VOID my_wm_size(_In_ LPARAM lParam, _In_ HWND hWnd, _In_ my_create crt, _In_ SCROLLINFO si);
                     ...
                     _In_ int       nCmdShow)
{
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MYSYSMETS));
...
VOID my_wm_paint(_In_ HWND hWnd, _In_ my_create crt)
{
    ...
    for (int i = iPaintBeg; i <= iPaintEnd; i++)
    {
        ...
        TextOut(hdc, x + 22 * crt.cxCaps, y, sysmetrics[i].szDesc, lstrlen(sysmetrics[i].szDesc));
