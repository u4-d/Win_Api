...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_APPLICATION));  // 加载大图标 IDI_APPLICATION
    wcex.hIconSm = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_INFORMATION));  // 加载小图标 IDI_INFORMATION
